	...
	var MovieTable = function MovieTable(props) {
	  ...
	  var movieNodes = props.movies.map(function (movie, index) {
	    return React.createElement(
	      'li',
	      null,
	      React.createElement(MovieRow, { id: index, value: index, movie: movie })
	    );
	  });
